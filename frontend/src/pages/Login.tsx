...
export default function Login() {
  ...
  return (
    <div className="max-w-md mx-auto mt-12 bg-medium-blue p-8 rounded-lg shadow-xl border border-border-color">
      <h2 className="text-2xl font-bold text-gold mb-6 text-center">Inicia Sesión</h2>
      ...
      <div className="mt-6 text-center text-sm text-gray-400">
        ¿No tienes cuenta? <Link to="/register" className="text-bright-blue hover:text-white transition">Regístrate aquí</Link>
      </div>
    </div>
  );
}
